...
export default function LoanCalculator() {
  ...
  return (
    <div className="w-full bg-gradient-to-br from-blue-50 via-blue-100/50 to-cyan-50 py-4 px-2.5 sm:py-8 sm:px-4">
      <div className="w-full max-w-xl mx-auto">
        <div className="bg-white rounded-[1rem] sm:rounded-[1.75rem] shadow-xl sm:shadow-2xl p-4 sm:p-8 md:p-10 space-y-5 sm:space-y-8 border border-blue-200/60">
